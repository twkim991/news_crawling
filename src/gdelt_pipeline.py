...
def main() -> None:
    ...
    parser.add_argument("--raw-output", default=GDELT_RAW_PATH, help="raw GKG csv path")
    parser.add_argument("--processed-output", default=GDELT_PROCESSED_PATH, help="processed csv path")
